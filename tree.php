    ...
    function toggleNode(node,indent,parent,expandAll,privatenode,loadChilds) {
        ...
        if (rpcNode.style.display != 'block') {
            ...
            if (rpcNodeText=="" || rpcNodeText.indexOf(loadText)>0) {
                ...
                new Ajax('index.php?a=1&f=nodes&indent='+indent+'&parent='+parent+'&expandAll='+expandAll+folderState+'&loadChilds='+loadChilds, {method: 'get',onComplete:rpcLoadData}).request();
            } else {
                rpcNode.style.display = 'block';
                //Jeroen set opened
                openedArray[parent] = 1 ;
